      ...
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-10">
          <div>
            ...
            <p className="mt-3 text-slate-600">Silakan hubungi kami untuk informasi kuota, jadwal, dan syarat pendaftaran.</p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-slate-700"><span className="font-semibold">Alur Pendaftaran:</span> Isi data singkat via WhatsApp, pilih jadwal, kemudian hadir ke lokasi untuk verifikasi.</p>
              </div>
            </div>

            <div className="mt-6 flex flex-wrap gap-3">
              <a href={whatsappLink} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-3 font-medium shadow-sm transition">
                <MessageCircle size={18} /> Chat WhatsApp Admin
              </a>
              <a href="tel:+62-812-3456-7890" className="inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 px-5 py-3 font-medium shadow-sm transition">
                <Phone size={18} /> 0812-3456-7890
              </a>
            </div>

            <div className="mt-8 rounded-xl bg-emerald-50 p-4 text-emerald-900 ring-1 ring-emerald-200">
              <p className="text-sm">Catatan: Kami menjaga privasi dan aurat santri dalam dokumentasi kegiatan. Orang tua dapat meminta dokumentasi khusus jika diperlukan.</p>
            </div>
          </div>
